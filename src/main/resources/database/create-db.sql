ALTER SESSION SET CURRENT_SCHEMA = DEN_JOAO;
...
CREATE SEQUENCE criterion_level_seq
    START WITH 1
    INCREMENT BY 50;
...
CREATE INDEX ix_root_cause_pro_id ON root_cause(pro_id);
CREATE SEQUENCE root_cause_seq
    START WITH 1
    INCREMENT BY 50;
...
CREATE SEQUENCE detected_incident_seq
    START WITH 1
    INCREMENT BY 50;
